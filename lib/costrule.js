...
let costRule = function costRuleFunc(inTimeRule,
  ...
  that.totalCost = function totalCostFunc(inDateSpans, inTZ=null) {
    ...
    let duration = caltime.measureDateSpans(overlaps,
                                          durationType,
                                          inTZ);
    switch(rateType) {
      case modconst.RATETYPE_PER_MILLISECOND:
        retval.cost = duration * rate;
        break;
      case modconst.RATETYPE_PER_SECOND_PRORATA:
        retval.cost = (duration / caltime.constants.MSECS_PER_SEC) * rate;
        break;
      case modconst.RATETYPE_PER_SECOND_ROUNDUP:

        break;
      case modconst.RATETYPE_PER_MINUTE_PRORATA:
        retval.cost = (duration / caltime.constants.MSECS_PER_MIN) * rate;
        break;
      ...
      case modconst.RATETYPE_PER_HOUR_PRORATA:
        retval.cost = (duration / caltime.constants.MSECS_PER_HOUR) * rate;
        break;
      ...
      case modconst.RATETYPE_PER_DAY_PRORATA:
        retval.cost = (duration / caltime.constants.MSECS_PER_DAY) * rate;
        break;
