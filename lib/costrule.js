...
let costRule = function costRuleFunc(inTimeRule,
  ...
  if (_.isObject(inTimeRule) === false) {
    throw new Error('Null or non-valid TimeRule argument passed to method.');
  }
  if (_.isInteger(inRateType) === false) {
    throw new Error('Null or non-valid rate type argument passed to method.');
  }
  if (_.isFinite(inRate) === false) {
    throw new Error('Null or non-valid rate argument passed to method.');
  }
